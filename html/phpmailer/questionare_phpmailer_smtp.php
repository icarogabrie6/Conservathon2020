...
<head>
    ...
    function delayedRedirect(){
        window.location = "../questionare_version.html"
    }
    </script>
...
try {
    ...
    $message .= "How do you describe your overall satisfaction: " . $_POST['satisfaction'] . "<br />";
    $message .= "How do you describe your carrer or profile:<br />" ;
